...
class CashierHistoryModel(QtCore.QAbstractTableModel):
    ...
    def headerData(self, section, orientation, role=QtCore.Qt.ItemDataRole.DisplayRole):
        ...
        if orientation == QtCore.Qt.Orientation.Horizontal:
            return ("Transaction ID", "Order Date", "Status", "Total", "Amount Paid", "Action")[section]
    ...
    def filter_by_id(self, transaction_id):
        filtered_data = [row for row in self._data if row[0] == transaction_id]
